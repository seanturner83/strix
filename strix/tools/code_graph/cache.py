"""Cache abstraction for code-graph indexes (SEC-6848 W1.2).
...
class NullCache:
    ...
    def get(self, key: CacheKey, dest: Path) -> bool:  # noqa: ARG002
        return False

    def put(self, key: CacheKey, source: Path) -> None:  # noqa: ARG002
        return
