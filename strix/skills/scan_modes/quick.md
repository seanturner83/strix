...
In quick mode, depth-cut is on Q4 (verification budget) — never on Q2
(threat enumeration). Better to surface 5 well-stated threats than 20 fuzzy
"assets at risk" bullets.

For STRIDE-per-element matrices and common mitigations per leg, see
